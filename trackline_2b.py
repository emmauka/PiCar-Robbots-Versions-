...
Track_line_speed = 40        # Speed of the car (in cm/s)
stop_distance = 910          # Distance limit to stop (in cm)
turn_duration = 1.7           # Duration for a 180-degree turn (adjust as needed)
